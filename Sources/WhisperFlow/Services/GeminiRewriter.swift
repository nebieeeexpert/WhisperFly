...
actor GeminiRewriter: TextRewriter {
    ...
    func rewrite(inputText: String, locale: Locale, mode: RewriteMode) async throws -> RewriteResultPayload {
        ...
        guard httpResponse.statusCode == 200 else {
            ...
            throw NSError(domain: "WhisperFlow", code: httpResponse.statusCode, userInfo: [NSLocalizedDescriptionKey: "OpenRouter rewrite error (\(httpResponse.statusCode)): \(errorBody)"])
        }
